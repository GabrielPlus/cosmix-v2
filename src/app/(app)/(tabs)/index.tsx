    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: white }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                ...
                {/* TAGLINE */}
                <View style={{ backgroundColor: lightBrown, paddingVertical: 12 }}>
                    <Text
                        style={{
                            textAlign: "center",
                            color: darkBrown,
                ...
                >
                    <View style={{ flexDirection: 'row', justifyContent: 'center', gap: 70, flexWrap: 'wrap' }}>
                        {[
                ...
                {/* FOOTER LINKS */}
                <View style={{ paddingVertical: 24, paddingHorizontal: 16, flexDirection: 'row', justifyContent: 'space-between' }}>
                    {/* Left Column */}
                    <View style={{ width: '48%' }}>
                        {["Käyttöehdot", "Meistä", "Tili", "Ota yhteyttä"].map((link, idx) => (
                            <TouchableOpacity key={idx} style={{ marginBottom: 30, justifyContent: 'center' }}>
                                <Text
                                    style={{
                                        color: darkBrown,
                                        fontSize: 15,
                    ...
                    {/* Right Column */}
                    <View style={{ width: '48%' }}>
                        {["Palvelut", "Etusivu", "Lahjakortit", "Ajanvaraus"].map((link, idx) => (
                            <TouchableOpacity key={idx} style={{ marginBottom: 30, justifyContent: 'center' }}>
                                <Text
                                    style={{
                                        color: darkBrown,
